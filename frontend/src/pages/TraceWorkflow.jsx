    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-sm p-4 font-sans">
      <div className="aiq-card w-full max-w-2xl overflow-hidden max-h-[85vh] flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800 flex items-center justify-between shrink-0">
          <div>
            <h2 className="text-xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight">Trace Workflow</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 font-black font-semibold tracking-normal">NO WORKFLOWS DEFINED</p>
              <p className="text-xs text-gray-800 dark:text-gray-200 mt-2 font-bold">Add workflows to this category in Configure.</p>
            </div>
          ) : (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-[10px] text-primary-600 font-black font-semibold tracking-normal">WORKFLOWS</p>
                  ...
                  return (
                    <div key={wfName} className={clsx(
                      ...
                      allCompleted
                        ...
                        : 'bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 hover:border-[#555]'
                    )}>
                      ...
                      >
                        <div className="shrink-0">
                          {toggling === wfName ? (
                            ...
                            <Circle size={22} className="text-gray-800 dark:text-gray-200 group-hover:text-primary-600 transition-colors" />
                          )}
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3">
                            <span className={clsx(
                              'text-sm font-black font-semibold tracking-normal',
                              allCompleted ? 'text-emerald-400 line-through' : 'text-gray-900 dark:text-gray-100'
                            )}>
                              {wfName}
                            </span>
                            <span className="text-[10px] text-gray-800 dark:text-gray-200 font-bold tracking-normal">
                      ...
                      <div className="border-t border-gray-100 dark:border-gray-800 px-4 pb-3">
                        {group.processes.map((proc, idx) => (
                          <div key={proc.process_id} className="flex items-center gap-3 py-2 px-2">
                            <span className="text-[9px] text-gray-700 dark:text-gray-300 font-black w-4 shrink-0">{idx + 1}.</span>
                            {proc.completed ? (
                              <CheckCircle2 size={12} className="text-emerald-500/50 shrink-0" />
                            ) : (
                              <Circle size={12} className="text-gray-700 dark:text-gray-300 shrink-0" />
                            )}
                            <span className={clsx(
                              'text-[10px] font-bold font-semibold tracking-normal truncate',
                              proc.completed ? 'text-gray-800 dark:text-gray-200 line-through' : 'text-gray-400'
                            )}>
                              {proc.name}
                            </span>
